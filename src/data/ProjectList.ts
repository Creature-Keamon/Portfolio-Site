	...
	},
	{
		...
		data: {
			...
			text: [
				...
				"The original site was designed to be a hub for all of the projects that I worked on and was currently working on. However it was made with raw HTML and CSS, which made it difficult and tedious to add reusable elements and interesting effects, like animations.",
				"So I have remade it with React.JS and Motion.JS. As I am using React, I was able to make the site extremely modular, making it extremely easy to add new pages that conform to my desired page design, and a new (conformant) page can be created with only a small amount of JSX. The source code is available from the Github link at the top of the page",
			],
		}
	},
	{
